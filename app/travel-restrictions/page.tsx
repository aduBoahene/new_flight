...
export default function page() {
  return (
    ...
    <h3 className="text-[#171766] text-2xl my-4 md:text-xl font-bold md:my-8">Travel Restrictions</h3>

      <p className="md:mt-4" style={{fontFamily:"Montserrat-Medium"}}>
      ...
      <h3 className="text-[#171766] my-4 md:text-xl font-bold md:my-8">Destinations you can travel to now</h3>
    </div>
  );
}
